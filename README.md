...
如果你想先把「自由書雲」、「一書一店」、「佛典漫畫」與「社區友好互助 / 預防孤獨死」整理成可執行的 Hermes 原型，請看 [數位蓮花藍圖](docs/digital-lotus.md)。它把願景拆成四大模組、Telegram / WebUI 最小工作流、Workspace 結構與可直接交給 Agent 使用的 Prompt。
